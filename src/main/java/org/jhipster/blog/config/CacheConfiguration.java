...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(org.jhipster.blog.domain.Rendezvous.class.getName(), jcacheConfiguration);
            cm.createCache(org.jhipster.blog.domain.Consultation.class.getName(), jcacheConfiguration);
            cm.createCache(org.jhipster.blog.domain.Facture.class.getName(), jcacheConfiguration);
            cm.createCache(org.jhipster.blog.domain.Aide.class.getName(), jcacheConfiguration);
