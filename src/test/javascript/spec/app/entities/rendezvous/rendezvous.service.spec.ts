    ...
    describe('Rendezvous Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/rendezvous';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Rendezvous', () => {
                service.create(new Rendezvous(null)).subscribe(received => {
            ...
            it('should update a Rendezvous', () => {
                service.update(new Rendezvous(123)).subscribe(received => {
