...
describe('Service Tests', () => {
    describe('Consultation Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ConsultationService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/consultations';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Consultation', () => {
                service.create(new Consultation(null)).subscribe(received => {
            ...
            it('should update a Consultation', () => {
                service.update(new Consultation(123)).subscribe(received => {
            ...
            it('should return a Consultation', () => {
            ...
            it('should return a list of Consultation', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Consultation(123)]);
            });
