...
describe('Service Tests', () => {
    describe('Aide Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AideService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/aides';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Aide', () => {
                service.create(new Aide(null)).subscribe(received => {
            ...
            it('should update a Aide', () => {
                service.update(new Aide(123)).subscribe(received => {
